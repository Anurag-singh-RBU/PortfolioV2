            ...
            {Illustration ? (
              ...
              <>
                <Image
                  ...
                  sizes={previewSizes}
                  loading="eager"
                  className={`object-cover duration-500 dark:hidden ${isHovered ? "grayscale" : "grayscale-0"}`}
                />
                <Image
                  src={previewDark}
                  alt={`${title} preview`}
                  ...
                  sizes={previewSizes}
                  loading="eager"
                  className={`hidden object-cover transition-[filter] duration-500 dark:block ${isHovered ? "grayscale" : "grayscale-0"}`}
                />
              </>
            ) : (
<Image
